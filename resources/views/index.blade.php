                ...
                <div class="row">
                    <div class="col-12">
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            <!-- Logo -->
                            <div class="logo">
                                <a href="{{asset('/')}}"><img src="{{asset('new/img/core-img/logo.png')}}" alt=""></a>
                            </div>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="#">Pages</a>
                                        <ul class="dropdown">
                                            <li><a href="{{asset('new/index.html')}}">Home</a></li>
                                            <li><a href="{{asset('new/catagories-post.html')}}">Catagories</a></li>
                                            <li><a href="{{asset('new/single-post.html')}}">Single Articles</a></li>
                                            <li><a href="{{asset('new/about.html')}}">About Us</a></li>
                                            <li><a href="{{asset('new/contact.html')}}">Contact</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="single-blog-post featured-post">
                                <div class="post-thumb">
                                    <a href="#"><img src="{{asset('new/img/bg-img/16.jpg')}}" alt=""></a>
                                </div>
                                <div class="post-data">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- Popper js -->
    <script src="{{asset('new/js/bootstrap/popper.min.js')}}"></script>
    <!-- Bootstrap js -->
    <script src="{{asset('new/js/bootstrap/bootstrap.min.js')}}"></script>
    <!-- All Plugins js -->
    <script src="{{asset('new/js/plugins/plugins.js')}}"></script>
    <!-- Active js -->
